...
function MessageNotifications() {
  ...
  const [showNotifications] = useSetting(settingsAtom, 'showNotifications');
  const [notificationSound] = useSetting(settingsAtom, 'isNotificationSounds');
  const [notificationBodyPreview] = useSetting(settingsAtom, 'notificationBodyPreview');
  ...
  const notify = useCallback(
    ({
      ...
      const noti = new window.Notification(roomName, {
        icon: roomAvatar,
        badge: roomAvatar,
        body: notificationBodyPreview ? `${username}: ${messageBody}` : `New inbox notification from ${username}`,
        silent: true,
      });
    ...
    [navigate, notificationBodyPreview]
  );
